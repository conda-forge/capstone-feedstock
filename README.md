...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/capstone-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/capstone-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add capstone cstool libcapstone
# for installing globally
pixi global install capstone cstool libcapstone
```
...
It is possible to list all of the versions of `capstone` available on your platform:
...
```
pixi search capstone --channel conda-forge
```
